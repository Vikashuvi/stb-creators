...
export const projects: Project[] = [
...

  {
    ...
    keywords: [
      ...
      "Youth/Gen-Z & Parent-Child Content",
      "Product Showcases & Educational Posts",
      "Micro-Influencer Collabs & Testimonials",
      "Engagement Posts, Challenges & Reels",
      "Social Media Strategy & Calendar",
      "Visual Identity & Creative Direction",
      "Launch Campaigns (products/features)",
      "Customer Reviews & Trust Messaging",
  ...
  // },
  {
    ...
    category: "Services",
    keywords: [
      "Creative Shoots of Acoustic Installs",
      "Client Testimonials & Reviews",
      "Process Videos (raw to treated space)",
      "Interactive Sound Series (polls, quizzes, myths)",
      "Brand Storytelling Posts",
      "Targeted Ads (Architects, Studios, Corporates)",
      "Collabs with Audio Engineers & Musicians",
      "LinkedIn B2B Brand Building",
      "Instagram Reels: Acoustic Tips",
      "Lead Funnel via Social CTAs & Forms",
    ],    
    summary: [
